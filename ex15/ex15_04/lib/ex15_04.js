...
function findWasmBinary() {
  return locateFile('ex15_04.wasm');
}
...
var _get_standard = Module['_get_standard'] = makeInvalidEarlyAccess('_get_standard');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['get_standard'] != 'undefined', 'missing Wasm export: get_standard');
  ...
  _get_standard = Module['_get_standard'] = createExportWrapper('get_standard', 2);
